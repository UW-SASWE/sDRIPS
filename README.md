# sD.R.I.P.S - Framework (Specific to Teesta Barrage Project)
...
5. **Run the `Canal_Water_Distribution_script.py`**:
    - The script estimates the deficit and surplus regions after the given water supply.
    ...
    - For help, users can type:
      ...
      ```
6. **[OPTIONAL] Run the `Plotting_Net_Water_Req.py`**:
    - The script generates the net water requirement plots based on the distribution file.
    - Users might need to change the names of a few columns to match their water supply files.
    - For help, users can type:
      ```bash
      python Canal_Water_Distribution_script.py -h
